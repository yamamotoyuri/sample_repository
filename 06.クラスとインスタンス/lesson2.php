...
$patient = new Patient("田中","1.60", "45");

$output = $patient->getName() . 'さんの身長は' . $patient->getHeight() . 'mなので平均体重は' . $patient->calculateStandardWeight() . 'kgです。 現在の体重は' . $patient->getWeight() . 'kgです。';
